...
def eval_line_level_at_commit(cur_proj, data_path,line_score_df_col_name,score_cols):
    ...
    top_5_acc_df.to_csv('./text_metric_line_eval_result/' + cur_proj + '_top_5_acc_min_df_3_300_trees.csv')
...
def plot_result(cur_proj):
    ...
    for i in range(0, 5):
        result_df = pd.read_csv(
            './text_metric_line_eval_result/' + cur_proj + '_' + metrics[i] + '_min_df_3_300_trees.csv')
